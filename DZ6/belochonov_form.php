...
//    {if (date("N",mktime(0,0,0,$month,1,$date1))==7) {$count++;}}
//    }
//    if ($count == 0) {echo "Воскресений небыло в первый день каждого месяца";}
//    else {echo "Вот столко воскресений в первое число каждого месяца : ".$count;}
