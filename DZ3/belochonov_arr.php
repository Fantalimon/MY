...
//    echo $arr[$i].' ';
//};
//// !!!!! сфункцией count($arr) не работает, зависает комп
...
//echo "</pre>";
//
//// !!! некорректно выводит колличество символов русского шрифта.
...
/*4. Определите тип следующих переменных с помощью функции gettype().
...
//$var[] = 2.5;
//$var[] = null;
//foreach($var as $key=>$type){echo"[$key]"."{$type}"."~~~~~~~".gettype($type)."<br>";};
//-------------------------------------------------------------------------------------------------------------------------------

// --------------------------------Конец заданиям из основ-----------------------------------------------------------------------
